...
Insert into SinhVien
values('SV05',N'Trần Khả Ái',CONVERT(date,'05/02/2003',103),'L02'),
	  ('SV06',N'Cao Hồng Nung',CONVERT(date,'22/11/2004',103),'L03'),
	  ('SV08',N'Cao Minh Chi',CONVERT(date,'02/04/2003',103),'L02')
...
DELETE FROM SinhVien WHERE MaSinhVien = 'SV009'
